					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								<li class="icon solid fa-phone">+91-9022367269</li>
								<li class="icon solid fa-envelope"><a href="#">E-Mail@orrs.com</a></li>
								<li class="icon brands fa-twitter"><a href="#">Twitter</a></li>
								<li class="icon brands fa-facebook-f"><a href="#">Facebook</a></li>
								<li class="icon brands fa-instagram"><a href="https://www.instagram.com/_its_swapy4111_/#">Instagram</a></li>
							</ul>
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li>Developed_By:- Waghe Swapnil</li>
							</ul>
						</div>
					</section>
