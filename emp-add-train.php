              ...
              <div class="card card-border-color card-border-color-success">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Train Rs/label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="fare"  id="inputText3" type="text" placeholder="Rs">
                      </div>
                    </div>
